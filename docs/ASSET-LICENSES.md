...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Three.js | 3D渲染底层 | https://github.com/mrdoob/three.js | Three.js Authors | MIT | 允许 | 允许 | 允许 | 保留许可 | 2026-07-15 | `public/licenses/Three.js-MIT.txt` |
| React | 页面与状态 | https://github.com/facebook/react | Meta Platforms | MIT | 允许 | 允许 | 允许 | 保留许可 | 2026-07-15 | `public/licenses/React-MIT.txt` |
...
| 《纳瓦尔宝典》演示转述 | 纳瓦尔内容包 | 用户提供中信出版社2022版PDF | 埃里克·乔根森，译者赵灿 | 内部演示授权范围待项目负责人确认 | 暂按内部测试使用 | 未确认 | 仅原创转述 | 出处已标注 | 2026-07-15 | 原PDF不进入构建；出处记录在内容包 |
| 雾灯镇来信 | 故事冒烟测试内容 | 本项目原创 | 星际互动 PlayDrama | 项目自有 | 允许 | 允许 | 允许 | 无 | 2026-07-15 | `src/content/smoke-test-story.js` |

接入豆包语音前需要确认接口权限、计费和生成音频的使用范围，并由项目负责人确认《纳瓦尔宝典》内容授权范围。原始PDF没有复制到应用目录，也不会进入在线构建。
