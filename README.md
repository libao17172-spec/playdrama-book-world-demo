...
在线演示地址：[https://libao17172-spec.github.io/playdrama-book-world-demo/](https://libao17172-spec.github.io/playdrama-book-world-demo/)
...
npm run build
npm run test:e2e
PLAYWRIGHT_BASE_URL='https://libao17172-spec.github.io/playdrama-book-world-demo/' npm run test:e2e
```
